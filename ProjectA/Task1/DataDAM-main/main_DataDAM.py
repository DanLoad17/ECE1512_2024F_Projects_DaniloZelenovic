...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='C:/Users/goran/venv/DataDAM-main/mnist_dataset', help='dataset path')
    parser.add_argument('--zca', type=bool, default=False, help='Zca Whitening')
    parser.add_argument('--save_path', type=str, default='C:/Users/goran/venv/DataDAM-main/saved', help='path to save results')
