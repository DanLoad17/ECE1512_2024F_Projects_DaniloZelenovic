...
def continual_learning(model, train_loader, val_loader, epochs, device):
...
def train_model_with_synthetic_data():
    ...
    val_dataset = CustomDataset(csv_file='C:\\Users\\goran\\venv\\DataDAM-main\\mhist_dataset\\annotations.csv', 
                                 img_dir='C:\\Users\\goran\\venv\\DataDAM-main\\mhist_dataset\\images\\images', 
    ...
    new_image_syn, new_label_syn = initialize_synthetic_data(num_classes, ipc, device)
    ...
    train_dataset = CustomDataset(csv_file='C:\\Users\\goran\\venv\\DataDAM-main\\mhist_dataset\\annotations.csv', 
                                   img_dir='C:\\Users\\goran\\venv\\DataDAM-main\\mhist_dataset\\images\\images', 
    ...
    continual_learning(lenet_model, train_loader, val_loader, epochs=10, device=device)
